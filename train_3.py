'''
1 episode 1 trajectory, alternative NN module
'''
...
def main(args):
    ...
    for episode in range(args.seed_episodes, args.all_episodes):
        ...
        for update_step in range(args.collect_interval): #100 steps
            ...
            if (update_step + 1) % 20 == 0:
                print('update_step: %3d loss: %.5f'% (update_step+1,policy_loss.item()))
    ...
    torch.save(ppo_agent.MLPBase_model.state_dict(), os.path.join(log_dir, 'actor_critic.pth'))
